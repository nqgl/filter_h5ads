...
def main():
    ...
    config = FilterPipelineConfig(
        ...
        umi_filter=UMIFilterConfig(
            min_counts=750,  # Minimum UMI threshold (adjust based on your data)
            count_column="gene_count",
            enabled=True,
        ),
        ...
        mito_filter=MitochondrialFilterConfig(
            max_pct_mt=0.11,  # Maximum 20% mitochondrial content
            mt_column="pcnt_mito",
            enabled=True,
        ),
        ...
        gene_filter=GeneDetectionFilterConfig(
            min_genes=400,  # Minimum genes with non-zero counts
            gene_column="gene_count",
            enabled=True,
        ),
    )
